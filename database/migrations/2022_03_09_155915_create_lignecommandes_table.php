...
class CreateLignecommandesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('lignecommandes', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('commande_id')->index('lignecommandes_commande_id_foreign');
            $table->unsignedBigInteger('produit_id')->index('lignecommandes_produit_id_foreign');
