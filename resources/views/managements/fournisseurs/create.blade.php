            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('fournisseur.store')}}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="{{old('nom_fournisseur',$fournisseur->nom ?? null )}}" id="nom_fournisseur" name="nom_fournisseur" class="form-control" placeholder="Nom/Raison sociale" />
                                        </div>
                                    </div>
                                    <!-- END Nom/Raison -->
                                    <!-- BEGIN Adresse -->
                        ...
                        <!-- ########################################## -->
                        <div class="form-group">
                            <button type="submit" class="btn btn-info btn-rounded" name="sendFournisseur" disabled>Valider</button>
                            &nbsp;&nbsp;&nbsp;&nbsp;
