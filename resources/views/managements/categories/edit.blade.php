                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select  class="form-control" id="type_categorie" name="type_categorie" class="form-control">
                                    ...
                                    <option value="stock" @if ($categorie->type_categorie == old('type_categorie','stock' ?? null)) selected="selected" @endif>Stockable</option>
                                    <option value="nstock" @if ($categorie->type_categorie == old('type_categorie','nstock' ?? null)) selected="selected" @endif>Non stockable</option>
                                    <option value="service" @if ($categorie->type_categorie == old('type_categorie','service' ?? null)) selected="selected" @endif>Service</option>
                                    <option value="consommable" @if ($categorie->type_categorie == old('type_categorie','consommable' ?? null)) selected="selected" @endif>Consommable</option>
                                </select>
